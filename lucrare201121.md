1. Create private repository ``task201121`` and open access for ``sergiuchilat`` (1)
...
5. Create repository layer according to your variant (1)
6. Create CRUD methods for model (2)
7. Create Postman collection with all CRUD methods and publish it to your repository (1)
8. Commits(minimum 7) on github and screend fom Postman (1)
